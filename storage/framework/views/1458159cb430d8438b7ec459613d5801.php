...
<body>
    ...
    <div class="invoice-purpose">
        <p><strong><u>Objet d'honoraire</u> :</strong> <?php echo e($record->object); ?>.</p>
    </div>
    ...
    <div class="invoice-table-container">
        <table class="invoice-table">
            <tr>
                <td>Montant H.T</td>
                <td>:</td>
                <td><?php echo e(number_format($record->montantHT, 3, '.', ',')); ?></td>
            </tr>
            <tr>
                <td>T.V.A <?php echo e($tva * 100); ?>%</td>
                <td>:</td>
                <td><?php echo e(number_format($record->tva, 3, '.', ',')); ?></td>
            </tr>
            <tr>
                <td>Montant T.T.C</td>
                <td>:</td>
                <td><?php echo e(number_format($record->montantTTC, 3, '.', ',')); ?></td>
            </tr>
            <tr>
                <td>R/S <?php echo e($rs * 100); ?>%</td>
                <td>:</td>
                <td><?php echo e(number_format($record->rs, 3, '.', ',')); ?></td>
            </tr>
            <tr>
                <td>Timbre Fiscal</td>
                <td>:</td>
                <td><?php echo e(number_format($record->tf, 3, '.', ',')); ?></td>
            </tr>
            <tr>
                <td><strong>Net à payer</strong></td>
                <td>:</td>
                <td><strong><?php echo e(number_format($record->netapayer, 3, '.', ',')); ?></strong></td>
            </tr>
        </table>
    </div>
    <br>
...
<?php /**PATH D:\Devs\Fido\resources\views\pdf.blade.php ENDPATH**/ ?>