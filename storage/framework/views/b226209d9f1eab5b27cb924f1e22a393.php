...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.dropdown.index','data' => ['teleport' => true,'placement' => $placement,'width' => $isFlagsOnly ? 'flags-only' : 'fls-dropdown-width','maxHeight' => $maxHeight,'class' => 'fi-dropdown fi-user-menu','dataNosnippet' => 'true']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['teleport' => true,'placement' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($placement),'width' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($isFlagsOnly ? 'flags-only' : 'fls-dropdown-width'),'max-height' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($maxHeight),'class' => 'fi-dropdown fi-user-menu','data-nosnippet' => 'true']); ?>
...
<?php endif; ?>
<?php /**PATH D:\Devs\Fido\vendor\bezhansalleh\filament-language-switch\resources\views\switch.blade.php ENDPATH**/ ?>